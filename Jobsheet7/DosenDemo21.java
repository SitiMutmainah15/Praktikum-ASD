...
public class DosenDemo21 {
    public static void main(String[] args) {
        ...
        while (true) {
            ...
            System.out.println("5. PencarianDataSequential21 (Berdasarkan Nama)");
            System.out.println("6. PencarianDataBinary21 (Berdasarkan Usia)");
            ...
            switch (pilihan) {
                ...
                case 5:
                    ...
                    data.PencarianDataSequential21(cariNama); 
                    break;
                case 6:
                    System.out.print("Masukkan usia dosen yang dicari: ");
                    int cariUsia = input.nextInt();
                    data.PencarianDataBinary21(cariUsia); 
                    break;
                case 7:
